            ...
            <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
              <div className="testimonial__wrapper">
                <div className="testimonial__item item-1">
                  <div className="button modal-trigger" ref={modalTrigger1}>
                    ...
                    <h2 className="testimonial__title">Celia Ramakrishnan</h2>
                    <h3 className="testimonial__role">CEO de Kally Kurls</h3>
                  </div>
                </div>
                <div className="sec-title-wrapper text-anim">
                  <h4 className="sec-sub-title">Témoignages</h4>
                  <h5 className="sec-title title-anim">
                    Ils parlent <br/>
                    de nous
                  </h5>
                  <p>
                    Des retours authentiques sur notre expertise, notre réactivité et nos résultats concrets.
                  </p>
                </div>
              </div>
              ...
              <div className="testimonial__item item-2">
                <div className="button modal-trigger-2" ref={modalTrigger2}>
                  ...
                  <h2 className="testimonial__title">David</h2>
                  <h3 className="testimonial__role">Coaching</h3>
                </div>
              </div>
            </div>
