...
import Service11 from "../../../public/assets/imgs/service/1/service_img_1.jpg";
import Service12 from "../../../public/assets/imgs/service/1/service_img_1.jpg";
import Service13 from "../../../public/assets/imgs/service/1/service_img_1.jpg";
import Service14 from "../../../public/assets/imgs/service/1/service_img_1.jpg";
import Service15 from "../../../public/assets/imgs/service/1/service_img_1.jpg";
          ...
          <div className="row">
            ...
            <div className="col-xxl-5 col-xl-5 col-lg-5 col-md-5">
              <div className="service__top-text text-anim">
                <p>
                  Avec chaque client, nous travaillons <span>avec passion</span>{" "} pour créer des <span>solutions digitales innovantes.</span>{" "}
                ...
                <div className="service__list" ref={serviceList}>
                    ...
                    <div className="service__item animation_home1_service">
                      ...
                      <div className="service__title-wrapper">
                        <h4 className="service__title">
                          Stratégie & <br/>Branding
                        </h4>
                      </div>
                      <div className="service__text">
                        <p>
                          Nous créons votre identité digitale et définissons la stratégie qui vous
                          positionne comme leader sur votre marché avec impact et cohérence.
                        </p>
                      </div>
                  ...
                  >
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__title-wrapper">
                        <h4 className="service__title">
                          Sites Internet & <br/>E-commerce                          
                        </h4>
                      </div>
                      <div className="service__text">
                        <p>
                          Nous développons des sites web performants et des boutiques en ligne 
                          optimisées qui convertissent vos visiteurs en clients fidèles.
                        </p>
                      </div>
                      <div className="service__link">
                        <p>
                  ...
                  >
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__title-wrapper">
                        <h4 className="service__title">
                          Email Marketing & <br/> Automatisation
                        </h4>
                      </div>
                      <div className="service__text">
                        <p>
                          Nous concevons des campagnes email ciblées et des funnels automatisés qui 
                          renforcent l'engagement et transforment vos contacts en clients récurrents.
                        </p>
                      </div>
                      <div className="service__link">
                        <p>
                  ...
                  >
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__title-wrapper">
                        <h4 className="service__title">
                          SEO & <br/> Référencement
                        </h4>
                      </div>
                      <div className="service__text">
                        <p>
                          Nous optimisons votre présence en ligne grâce à des techniques de 
                          référencement avancées qui positionnent votre entreprise en tête des résultats de recherche.
                        </p>
                      </div>
                      <div className="service__link">
                        <p>
                  ...
                  >
                    <div className="service__item  animation_home1_service">
                      ...
                      <div className="service__title-wrapper">
                        <h4 className="service__title">
                          Social Media <br/> Advertising (SMA)
                        </h4>
                      </div>
                      <div className="service__text">
                        <p>
                          Nous créons des campagnes publicitaires performantes sur Facebook, Instagram et LinkedIn qui 
                          génèrent des leads qualifiés et boostent vos conversions.
                        </p>
                      </div>
                      <div className="service__link">
                        <p>
